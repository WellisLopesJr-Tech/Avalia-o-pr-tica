    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        List<Produto> produtos = new()
        {
            ...
            new Produto(){
                ...
                Descricao = "Com uma Cervejeira Consul Mais você não precisa mais se preocupar se suas cervejas vão congelar ou se elas não vão ficar geladas na hora que opessoal chegar. Você pode mudar a configuração das prateleiras da sua Cervejeira",
                Preco = 2166.03M,
                Estoque = 4,
                CategoriaId = 5,
